    ...
    <div class="container">
      <h1>Churn Analytics</h1>
		 ...
		 <div class="entry cntboxinner">
			...
			<h4>How to Make Friends and Influence People</h4>
			<ul class="datemainbox">
			<li>January 2, 2015</li>
			<li class="cmntli">0 Comments</li>
			</ul>
				<p>We wear different hats every day. And the way we communicate changes based on the hat we are wearing..boss, employee, friend, husband (wife), mother (father)...</p>
				<img src="img/hats1.jpg"/>
...
<h4>Start with the broadest category definitions.</h4>
...
<img class="churmimgs" src="img/Happy-guys.png"/>
<h4>Give new customers the best experience possible</h4>
...
<div class="clearbox"></div>
<div class="col-md-6">
<b>One Time Customers</b> are those who never returned after an initial interaction, and who you want to reengage. This is a group that can be incentivized with particularly attractive offers to return in the short term, but may or may not transition to active customers.
</div>

<div class="col-md-6">
<b>New Customers with High Potential</b> are those with the highest potential long-term value. This group can be identified by using customer lifetime value forecasting models, which incorporate behavioral and demographic data to predict likely future behavior. Or a simpler , albeit less accurate, method is to take the top 5%-10% of New Customers based on the value of their first transaction and provide VIP service, long-term incentive programs, or customized offers to keep them engaged for expended periods of time.
</div>
<div class="clearbox"></div>
<h3>Cluster active customers to deliver a more personalized experience.</h3>
<div class="col-md-12 imgsection">
<img class="chuns1img" src="img/a.png"/>
<div class="clearbox"></div>
</div>
...
<div class="clearbox"></div>
<h4>Define inactive customers</h4>

<img class="churmimgs" src="img/churn1.png"/>
<div class="clearbox"></div>
